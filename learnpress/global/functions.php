...
function theme_name_scripts() {
	...
	wp_enqueue_style( 'my-style-idea', get_template_directory_uri() . '/assets/css/ideas/my-style-idea.css?6' );
	...
	wp_enqueue_script( 'ideas-app', get_template_directory_uri() . '/assets/js/ideas/app.js?6', array(), '1.0.0', true );
	...
	wp_enqueue_script( 'ideas-ajax', get_template_directory_uri() . '/assets/js/ideas/ajax-idea.js?6', array(), '1.0.0', true );
...
// 	wp_enqueue_script( 'script-datatables', get_template_directory_uri() . '/assets/plugins/custom/datatables/datatables.bundle.js', array(), '1.0.0', true );
		...
		wp_enqueue_script( 'script-custom', get_template_directory_uri() . '/assets/js/custom.js?6', array(), '1.0.0', true );
