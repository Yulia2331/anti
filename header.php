...
<html lang="ru">
	...
	<body>
		...
		<?php 
			...
			if(str_contains(str_replace('/',' ',$wp->request),'lessons')){
				get_template_part('/template-parts/aside-left-lesson'); 
			}else{
				get_template_part('/template-parts/aside-left'); 
			}
          ...
          <button class="general-function__button general-function__search container__icon--24"> <i class="fa-solid fa-magnifying-glass"></i></button>
		      ...
		      <button class="general-function__button general-function__messages container__icon--24"> <i class="fa-regular fa-message"></i></button>
				  ...
				  <div class="private-messages">
					  <?  if( have_rows('messages', 'user_'.$currrent_userID) ):
						while ( have_rows('messages', 'user_'.$currrent_userID) ) : the_row();
						$user_id = get_sub_field('message_sender');
						$user = get_userdata( $user_id );
						$first_name = $user->first_name;
			        	$last_name  = $user->last_name;
						?>
						<div class="private-messages__item" date-msgind="<?php echo get_row_index(); ?>">
							<div class="d-flex">
							<div class="symbol symbol-50px me-5"> <img src="<?=get_user_image($user_id)?>"></div>
								<div class="">
									<span class="private-messages__name reviews-idea__name"><? echo $first_name; echo '&nbsp'; echo $last_name; ?></span>
									<div class="fw-bold text-muted text-hover-primary fs-7 mt-2"><? the_sub_field('message_date'); ?></div>
								</div>
							</div>
							<div class="private-messages__text">
					...
					<div class="d-flex align-items-stretch " >
						...
						<div id="kt_header_search" class="d-flex align-items-stretch" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-menu-trigger="auto" data-kt-menu-overflow="false" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-end">
							...
							<button class="general-function__button general-function__search container__icon--24" data-kt-search-element="toggle" id="kt_header_search_toggle"> <i class="fa-solid fa-magnifying-glass"></i></button>

							<!--begin::Search toggle-->
							<div class="d-flex align-items-center" data-kt-search-element="toggle" id="kt_header_search_toggle" style="display:none !important;">
					...
					<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle" data-user-id="<?=get_current_user_id()?>">
						...
						<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
							<?php $currrent_userID =  get_current_user_id();
								$user_info = get_userdata($currrent_userID);
							?>
							<div style="height:35px; width: 35px; background-image: url(<?= get_user_image($currrent_userID) ?>) ; background-size: cover; border-radius:6px;">
