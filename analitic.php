					...
					<div id="kt_content_container" class="container-xxl">
						...
						<div class="row fv-row mb-7" >
							...
							<div class="btn-group" role="group" aria-label="" id="analitic-checker">
								<input type="radio" data-href='/analitika/' class="btn-check" name="analitic-checker" id="btnradio1" value='club' autocomplete="off" checked>
								<label class="btn btn-primary" for="btnradio1">Аналитика клуба</label>
							 
								<input type="radio" data-href='/analitika-pkm/' class="btn-check"  id="btnradio2" name="analitic-checker" value='pkm' autocomplete="off">
								<label class="btn btn-secondary" for="btnradio2">Аналитика ПКМ</label>
													...
													<div class="card card-flush h-md-100 mb-5 mb-10">
														...
														<div class="card-header pt-5">
															...
															<div class="card-title d-flex flex-column">
																...
																<div class="d-flex align-items-center">
																	...
																	?>
																	<!--begin::Amount-->
																	<span class="fs-2hx fw-bolder text-dark me-2 lh-1 ls-n2"><?php echo count($all_users)?> человек</span>
																	<!--end::Amount-->
														...
														<div class="card-body pt-2 pb-4 d-flex align-items-center">
															...
															<div class="d-flex flex-center me-5 pt-2 w-100">
																<canvas id="kt_card_widget_4_chart_custom" style="" data-kt-size="109" data-kt-line="11"></canvas>
															</div>
															<!--end::Chart-->
								...
								<div class="col-xxl-4 mb-md-5 mb-xl-10">
									<div class="row g-5 g-xl-10">
										...
										<div class="col-md-12 col-xl-12 mb-xxl-10">
											<!--begin::Card widget 5-->
											<?php 
												get_template_part('/template-parts/user_earnings_klub');
											?>
											<!--end::Card widget 5-->
											<?php 
												get_template_part('/template-parts/new-clients-month-klub');
											?>
										</div>
									</div>
								</div>
