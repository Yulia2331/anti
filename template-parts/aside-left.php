								...
								<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
									...
									<div class="menu-item <?php echo (is_page(244))?'here':'' ?>">
										...
										<div class="menu-item <?php echo (is_page(255)?'here':'')?>">
											...
											<div class="menu-item <?php echo (is_page(428)?'here':'')?>">
												<a class="menu-link" href="<?php echo home_url(); ?>/teacher">
													<span class="menu-icon">
														<!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
														<span class="svg-icon svg-icon-2">
															<svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
													...
													<span class="menu-title">Страница учителя</span>
												</a>
											</div>
											...
											<div class="menu-item <?php echo (is_page(428)?'here':'')?>">
												<a class="menu-link" href="<?php echo home_url(); ?>/home-work">
													<span class="menu-icon">
														<!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
														<span class="svg-icon svg-icon-2">
															<svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
													...
													<span class="menu-title">Мои задания</span>
												</a>
											</div>
