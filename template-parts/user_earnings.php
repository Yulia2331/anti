												...
												<!-- <div class="card-body d-flex align-items-end pt-0">
													...
													<?php if ($goal>$earning){?>
														...
														<div class="h-8px mx-3 w-100 bg-light-danger rounded">
															<div class="bg-danger rounded h-8px" role="progressbar" style="width: <?php echo $pecent>=100?"100":(int)$pecent ?>%;" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
														</div>
													<?php }
														else{
															?>
