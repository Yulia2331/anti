...
function getMaleUsersArr(){
  let users = [];
  $.ajax({
    url: "/wp-admin/admin-ajax.php",
    data: {
      action:'get_male_users'
    },
    async: false,
...
function getMaleUsersArrPkm(){
  let users = [];
  $.ajax({
    url: "/wp-admin/admin-ajax.php",
    data: {
      action:'get_male_users_pkm'
    },
    async: false,
    success: function(response){
...
var KTChartsWidget4 = function () {
    ...
    var initChart = function() {
      ...
      if  (document.getElementById("kt_charts_widget_4_pkm")){
        element = document.getElementById("kt_charts_widget_4_pkm");
      }
      if (!element) {
          return;
      }
      ...
      let arrUsers = []
        if  (document.getElementById("kt_charts_widget_4_pkm")){
          arrUsers = getMaleUsersArrPkm();
        }
        else{
          arrUsers = getMaleUsersArr();
        }
...
function getCityUsersPkm(){
  let cities = [];
  $.ajax({
    url: "/wp-admin/admin-ajax.php",
    data: {
      action:'get_city_users_pkm'
    },
    async: false,
    success: function(response){
      cities = JSON.parse(response);
...
var KTChartsWidget5 = function () {
    ...
    var initChart = function() {
        ...
        if  (document.getElementById("kt_charts_widget_5_pkm")){
          element = document.getElementById("kt_charts_widget_5_pkm");
        }
        ...
        var borderColor = KTUtil.getCssVariableValue('--bs-border-dashed-color');
        if  (document.getElementById("kt_charts_widget_5_pkm")){
          arrCituiies = getCityUsersPkm();
        }
        else{
          arrCituiies = getCityUsers();
        }
        let cities = Object.keys(arrCituiies);
        let values = Object.values(arrCituiies);
...
function getSpherUsers(){
  let users = [];
  $.ajax({
    url: "/wp-admin/admin-ajax.php",
    data: {
      action:'get_spher_users'
    },
    async: false,
    success: function(response){
      users = JSON.parse(response);
...
function getSpherUsersPkm(){
  let users = [];
  $.ajax({
    url: "/wp-admin/admin-ajax.php",
    data: {
      action:'get_spher_users_pkm'
    },
    async: false,
    success: function(response){
      users = JSON.parse(response);
...
var KTChartsWidget6 = function () {
    ...
    var initChart = function() {
      ...
      if  (document.getElementById("kt_charts_widget_6_pkm")){
        element = document.getElementById("kt_charts_widget_6_pkm");
      }
      if (!element) {
          return;
      }
      ...
      let arrUsers2 = []
      if  (document.getElementById("kt_charts_widget_6_pkm")){
        arrUsers2 = getSpherUsersPkm();
      }
      else{
        arrUsers2 = getSpherUsers();
      }
      ...
      var options = {
          ...
          xaxis: {
              ...
              categories: ['Товарка', 'Универсал', 'Эксперт', 'Ищу себя'],
              labels: {
                  formatter: function (val) {
                    return val + ""
                  },
