/******/ (() => { // webpackBootstrap
	...
	var KTAppCalendar = function () {
		 ...
		 var initCalendarApp = function () {
			  // Define variables
			  var calendarEl = document.getElementById('kt_calendar_app_pkm');
			  ...
			  calendar = new FullCalendar.Calendar(calendarEl, {
					googleCalendarApiKey: 'AIzaSyAKlRDouzr4mJlP7kAdFzk_DF5f_yL0yT4',
					headerToolbar: {
						 left: 'prev,next',
						 center: 'title',
						 right: 'today'
					...
					events: {
						 googleCalendarId: 'c_625f5gaou2shnufrg7qd44th54@group.calendar.google.com'
					},
